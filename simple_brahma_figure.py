#!/usr/bin/env python3
"""
Simple Brahma's Knot figure generation
"""
...
def simple_brahma_figure():
    """Generate simple Brahma's Knot figure"""
    print("🎨 Simple Brahma's Knot Figure Generation")
    print("=" * 50)
    ...
    # Generate Brahma's Knot paths directly
    ...
    # Draw the pattern
    draw_brahma_pattern(ax, brahma_paths, points)
...
• Template: {brahma_template.name}
    ...
    # Save the figure
    plt.tight_layout()
    plt.savefig('brahma_knot_simple.png', dpi=300, bbox_inches='tight')
    print("✅ Figure saved as 'brahma_knot_simple.png'")
    
    # Don't show the figure (non-interactive)
    # plt.show()
    
    print("\n🎉 Brahma's Knot figure generated successfully!")
    print("   Check 'brahma_knot_simple.png' for the high-quality image")

def draw_brahma_pattern(ax, paths, points):
